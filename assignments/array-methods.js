...
// let fullName = [];
    ...
    // let fullName = runners.forEach(function (first_name){
...
// The large shirts won't be available for the event due to an ordering issue.  Get a list of runners with large sized shirts so they can choose a different size. Return an array named largeShirts that contains information about the runners that have a shirt size of L and log the result
    ...
    // let largeShirts = runners.filter(needShirt => needShirt.shirt_size === "L");
...
// let ticketPriceTotal = (accumulator, currentValue) => accumulator + currentValue;

// console.log(.reduce(ticketPriceTotal));
...
// Problem 1
    ...
    /*Filters out last name starting with A or B*/


    // let namesAToK = runners.filter(name => name.last_name[0] === "A" || name.last_name[0] === "B" );
    // console.log(namesAToK);


// Problem 2

/*Extracts all company Names alphabetically */

    // let companySponsors = runners.map(coName => coName.company_name);

    // console.log(companySponsors.sort());

// Problem 3
/*filters top donors into new array*/

    // let topDonors = runners.filter(giveMoney => giveMoney.donation >= 200);

    // console.log(topDonors.sort())